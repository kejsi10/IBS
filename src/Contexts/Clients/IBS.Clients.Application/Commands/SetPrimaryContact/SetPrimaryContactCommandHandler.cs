...
/// </summary>
public sealed class SetPrimaryContactCommandHandler(
    IClientRepository clientRepository,
    IUnitOfWork unitOfWork) : ICommandHandler<SetPrimaryContactCommand>
{
    /// <inheritdoc />
    public async Task<Result> Handle(SetPrimaryContactCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            client.SetPrimaryContact(request.ContactId);
