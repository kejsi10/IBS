...
public sealed class OllamaOptions
{
    ...
    /// <summary>Gets or sets the coder model identifier used for template editing and PDF import (e.g., "qwen2.5-coder:7b").</summary>
    public string CoderModel { get; set; } = "qwen2.5-coder:7b";
