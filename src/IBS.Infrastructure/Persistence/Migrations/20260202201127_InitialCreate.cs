        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SsnEncrypted = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
                    BusinessName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    DbaName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    EinEncrypted = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommunicatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgencyCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenantCarriers_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedFromUserAgent = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_ClientId_AddressType_IsPrimary",
                table: "Addresses",
                columns: new[] { "ClientId", "AddressType", "IsPrimary" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Communications_CommunicatedAt",
                table: "Communications",
                column: "CommunicatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantCarriers_TenantId_CarrierId",
                table: "TenantCarriers",
